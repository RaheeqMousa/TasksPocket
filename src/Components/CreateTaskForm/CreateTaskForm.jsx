    ...
    return(
        <div className={`flex flex-direction-column controls`}>
            ...
            <div className={`flex field`}>
                ...
                <textarea id="description" placeholder="Enter task's description"  cols={15} rows={3} {...register('description',{required:"Description is required"})}/>
            </div>
            <p className="error">{errors.description? errors.description.message:''}</p>
            <div className={`flex field`}>
                <label htmlFor="duedate">Due Date:</label>
                <input id="duedate" type="date" placeholder="Enter task's duedate"  {...register('dueDate',{required:"Duedate is required"})}/>
            </div>
